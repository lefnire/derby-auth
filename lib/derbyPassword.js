...
//            };
            ...
            // Override render here with custom Derby code
            var model = req.getModel();
            render = function(locals) {
                model.set('_everyauth', locals);
//                next();
            }
...
var password = module.exports =
    everyModule.submodule('derbyPassword')
        .configurable({
...
//            , registerLayout: 'the name or path to the layout you want to use for your registration page'
            ...
            , bypassRender: "Set to `true` if you'll be handling rendering yourself. This is true, for example, when using Everyauth with Derby"
        })
