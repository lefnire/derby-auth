...
var MongoStore, app, coffeeify, createUserId, derby, express, expressApp, liveDbMongo, mongoUrl, racerBrowserChannel, redis, redisUrl, serverError, store;
...
mongoUrl = process.env.MONGO_URL || process.env.MONGOHQ_URL || 'mongodb://localhost:27017/derby-auth';
